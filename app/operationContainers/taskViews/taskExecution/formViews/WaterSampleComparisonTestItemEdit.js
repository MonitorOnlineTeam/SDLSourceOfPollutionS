 ...
 * @LastEditTime: 2024-07-01 19:16:21
 * @FilePath: /SDLMainProject37_1/app/operationContainers/taskViews/taskExecution/formViews/WaterSampleComparisonTestItemEdit.js
 */
...
export default class WaterSampleComparisonTestItemEdit extends Component {
    ...
    confirm = () => {
        this.props.dispatch(
            createAction('waterSampleComparisonTestModel/delSubtable')({
                params: { ID: SentencedToEmpty(this.props, ['navigation', 'state', 'params', 'item', 'ParametersID'], '') }
            })
        );
    };
    ...
    render() {
        ...
        let options = {
            headTitle: '提示',
            messText: `确认删除${SentencedToEmpty(this.props.navigation, ['state', 'params', 'item', 'ParametersName'], '')}水样比对试验记录吗？`,
