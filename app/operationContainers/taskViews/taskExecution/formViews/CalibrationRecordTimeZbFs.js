...
// @connect()
class CalibrationRecordTimeZb extends Component {
    ...
    getBeginTimeSelectOption = () => {
        return {
            ...
            onSureClickListener: time => {
                ...
                this.props.dispatch(createAction('calibrationRecordZbFs/updateState')({ MainInfo: newMainInfo }));
            }
        };
    };
...
export default CalibrationRecordTimeZb;
