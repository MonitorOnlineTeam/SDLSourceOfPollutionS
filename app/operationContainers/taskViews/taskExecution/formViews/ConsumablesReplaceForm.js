...
class ConsumablesReplaceForm extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            chooseTime: this.props.navigation.state.params ? this.props.navigation.state.params.item.ReplaceDate : moment().format('YYYY-MM-DD'),
            consumablesName: this.props.navigation.state.params ? this.props.navigation.state.params.item.ConsumablesName : '', //易耗品名称
                        ...
                        <View style={{ borderRadius: 2, width: SCREEN_WIDTH - 20, minHeight: 250, marginLeft: 10, marginTop: 20, backgroundColor: 'white' }}>
                            ...
                            <View style={{ height: 50 }}>
                                <View style={{ flexDirection: 'row', width: SCREEN_WIDTH - 20 }}>
                                    <Text style={[styles.title, { flex: 1 }]}>易耗品名称</Text>
...
export default ConsumablesReplaceForm;
