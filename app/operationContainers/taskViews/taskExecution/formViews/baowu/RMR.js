...
@connect(({ patrolModelBw }) => ({
  workTimeStart: patrolModelBw.workTimeStart,
  workTimeEnd: patrolModelBw.workTimeEnd,
}))
class RMR extends Component {
  ...
  jumpToRMRForm = params => {
    ...
    this.props.navigation.navigate('RMRForm_BW', {
      params: {
        TaskID: TaskID,
        TypeID: TypeID,
        onOK: this.onOK,
  ...
  onOK = (record, resolve) => {
    ...
    this.props.dispatch(
      createAction('patrolModelBw/AddOrUpdateRecord')({
        actionType: 'AddOrUpdateStandardGasRepalceRecordBW',
        params: body,
        callback: result => {
  ...
  GetAllRecord = () => {
    ...
    this.props.dispatch(
      createAction('patrolModelBw/GetAllRecord')({
        actionType: 'GetStandardGasRepalceRecordBW',
        params: {
          taskID: TaskID,
          typeID: TypeID,
        },
  ...
  onSubmit = () => {
    ...
    this.props.dispatch(
      createAction('patrolModelBw/AddOrUpdateRecord')({
        actionType: 'SubmitStandardGasRepalceRecordBW',
        params: body,
        callback: result => {
          if (result.status == 200) {
            this.props.dispatch(
  ...
  onDeleteRecord = () => {
    ...
    this.props.dispatch(
      createAction('patrolModelBw/DeleteRecord')({
        actionType: 'DeletetStandardGasRepalceRecordBW',
        ...
        <View style={styles.standardItem}>
          <View style={styles.standardContent}>
            ...
            <View style={styles.standardRow}>
              ...
              <Text style={styles.value}>{item.StandardGasName}</Text>
            </View>
            <View style={styles.standardRow}>
              <Text style={styles.label}>气体浓度：</Text>
              <Text style={styles.value}>{record.StandardGasDensity}</Text>
            </View>
            <View style={styles.standardRow}>
