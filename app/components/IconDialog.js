 ...
 * @LastEditTime: 2024-09-12 10:47:12
 * @FilePath: /SDLMainProject/app/components/IconDialog.js
 */
                    ...
                    <View style={{ minWidth: 270, alignItems: 'center' }}>
                        <View style={{ width: 270, height: 89, zIndex: 10, flexDirection: 'row' }}>
                            ...
                            {this.props.hasCloseButton ? <TouchableOpacity
                                ...
                                <View style={{
                                    height: 16, width: 16, borderRadius: 8, borderWidth: 1, borderColor: 'white', backgroundColor: 'transparent'
                        ...
                        <View style={{
                            minWidth: 270, borderRadius: 10, backgroundColor: 'white'
