 ...
 * @LastEditTime: 2024-09-09 10:17:38
 * @FilePath: /SDLMainProject/app/components/form/SimpleMultipleItemPicker.js
 */
import React, { PureComponent } from 'react';
import { Text, View, Image } from 'react-native';

import MoreSelectTouchable from './MoreSelectTouchable';
const ic_arrows_down = require('../../images/ic_filt_arrows.png');

export default class SimpleMultipleItemPicker extends PureComponent {
    constructor(props) {
        super(props);
