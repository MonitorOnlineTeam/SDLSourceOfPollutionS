...
export default Model.extend({
    ...
    effects: {
        ...
        *getEnterpriseListApp(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.xj.GetEnterpriseListApp, params);
        ...
        *getOperationHistoryRecordByDGIMN(
            ...
            let { TaskRecordIndex, TaskRecordData } = yield select(state => state.enterpriseListModel);
            const result = yield call(axiosAuthPost, api.pollutionApi.xj.GetOperationHistoryRecordByDGIMN, params);
            let status = SentencedToEmpty(result, ['status'], -1);
        ...
        *getConstructionCorpsList({ payload }, { call, put, update, take, select }) {
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.xj.GetConstructionCorpsList, {});
            if (typeof SentencedToEmpty(result, ['data'], {}).Datas != 'undefined' && SentencedToEmpty(result, ['data'], {}).Datas) {
        ...
        *getMonitorTargetList(
            ...
            let { targetType, strName, regionCode } = yield select(state => state.enterpriseListModel);
            let paramString = `targetType=${targetType}&strName=${strName}`;
            if (regionCode) {
                paramString = paramString + '&regionCode=' + regionCode;
            }
            let requestBegin = new Date().getTime();
            const result = yield call(axiosAuthGet, api.pollutionApi.PointInfo.GetMonitorTargetList, null, paramString);
            let requestEnd = new Date().getTime();
        ...
        *getAirPointList(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.GetAirPointList, {
                DataType: 'HourData',
                Time: moment()
                    .subtract(1, 'hours')
        ...
        *getAirPointDetails(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.GetAirPointDetails, params);
        ...
        *commitStops(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.CommitStop, params);
        ...
        *updateStops(
            ...
            params.DGIMN = outputStopListDGIMN;
            yield update({ commitStopResult: { status: -1 } });
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.UpdateStop, params);
        ...
        *commitAbnomal(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.CommitAbnormal, params);
        ...
        *commitBaseFac(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.CommitBaseFac, params);
        ...
        *BaseFacilities(
            ...
            const result = yield call(axiosAuthPost, api.pOperationApi.OperationForm.BaseFacilitiesInfo, params);
        ...
        *deleteStopsRec(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.DeleteStopRec, null, `ID=${params.ID}`);
        ...
        *deleteAbnormalRec(
            ...
            yield update({ deleteStopsStatus: { status: -1 } });
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.DeleteAbnormalRec, null, `ID=${params.ID}`);
            yield update({ deleteStopsStatus: result });
            yield put('pointDetails/getAbnormalList', {});
            // callback();
        },
        ...
        *getSiteDataList(
            ...
            const result = yield call(axiosAuthPost, api.pollutionApi.PointInfo.GetSiteDatas, params);
