...
export default Model.extend({
    ...
    reducers: {
        updateState(state, { payload }) {
            console.log('alarmAnaly updateState payload = ', payload);
    ...
    effects: {
        ...
        *StatisLinearCoefficient({ payload }, { update, take, call, put }) {
            ...
            const result = yield call(dataAnalyzeAuth.axiosAuthPost, api.DataAnalyze.StatisLinearCoefficient, payload);
            if (result.data && result.data != null && result.data.IsSuccess == true) {
        ...
        *StatisPolValueNumsByDGIMN({ payload }, { update, take, call, put }) {
            ...
            const result = yield call(dataAnalyzeAuth.axiosAuthPost, api.DataAnalyze.StatisPolValueNumsByDGIMN, payload);
            if (result.data && result.data != null && result.data.IsSuccess == true) {
        ...
        *GetPointParamsRange({ payload }, { update, take, call, put }) {
            ...
            const result = yield call(dataAnalyzeAuth.axiosAuthPost, api.DataAnalyze.GetPointParamsRange, payload);
            if (result.data && result.data != null && result.data.IsSuccess == true) {
