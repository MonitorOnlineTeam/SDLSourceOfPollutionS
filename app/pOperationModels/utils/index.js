...
export const checkAlarmByTargetID = (TargetID, realTimeAlarms) => {
    if (realTimeAlarms) {
        return realTimeAlarms.find(alarm => {
            return alarm.ParentCode == TargetID;
        });
    }
    return null;
};
...
export const getTargetImageByType = type => {
    if (type == 1 || type == '1') {
        ...
        //大气站
        return {
            image_circle: require('../../images/ic_station_circle.png'),
            image: require('../../images/ic_station_circle.png'),
            name: '大气站'
        };
        ...
        return {
            ...
            image: require('../../images/ic_site_circle.png'),
            name: '工地'
        };
    } else {
        return {
...
export const getImageByType = type => {
    if (type == 1 || type == '1') {
        ...
        return {
            ...
            image: require('../../images/ic_water_circle.png'),
            name: '废水排口'
        };
    } else if (type == 2 || type == '2') {
        //废气
        return {
            ...
            image: require('../../images/ic_gas_circle.png'),
            name: '废气排口'
        };
        ...
        return {
            ...
            image: require('../../images/ic_dust_circle.png'),
            name: '扬尘'
        };
        ...
        return {
            ...
            image: require('../../images/ic_voc_circle.png'),
            name: 'VOC'
        };
    } else {
        return {
