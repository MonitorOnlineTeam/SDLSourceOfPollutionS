...
@connect(({ modelAnalysisAectificationModel }) => ({
    ...
    checkedRectificationCompleteListData: modelAnalysisAectificationModel.checkedRectificationCompleteListData,
    checkedRectificationCompleteListResult: modelAnalysisAectificationModel.checkedRectificationCompleteListResult
}))
export default class AnalysisModelAbnormalRectificationRecords extends Component {
    ...
    simpleRefresh = () => {
        this.props.dispatch(createAction('modelAnalysisAectificationModel/getCheckedRectificationCompleteList')({
            params: {}
        }));
    }
