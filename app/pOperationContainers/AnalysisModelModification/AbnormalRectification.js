...
export default class AbnormalRectification extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  confirm = () => {
    if (this.checkParams()) {
      this.props.dispatch(
        createAction(
          'modelAnalysisAectificationModel/updateCheckedRectification',
        )({
          params: {
            id: this.state.ID,
  ...
  render() {
    ...
    return (
      <StatusPage
              ...
              <View
                ...
                <View
                  ...
                  <PickerSingleTimeTouchable
                    ...
                    option={this.getCompletionTimeOption()}
                    style={{
                      flexDirection: 'row',
                ...
                <View
                  ...
                  <ImageGrid
                    ...
                    uploadCallback={items => {
                      let newImages = SentencedToEmpty(
                        this.state,
                        ['images'],
                        [],
                      ).concat(items);
                    ...
                    delCallback={index => {
                      let newImages = [].concat(
                        SentencedToEmpty(this.state, ['images'], []),
                      );
        ...
        {SentencedToEmpty(
          this.props,
          ['updateCheckedRectificationResult', 'status'],
          200,
        ) == -1 ? (
          <SimpleLoadingView message={'提交中'} />
        ) : null}
