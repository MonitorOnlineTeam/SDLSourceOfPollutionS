...
@connect(({ modelAnalysisAectificationModel }) => ({
    updateCheckedRectificationResult: modelAnalysisAectificationModel.updateCheckedRectificationResult
}))
export default class AbnormalRectification extends Component {
    ...
    confirm = () => {
        if (this.checkParams()) {
            this.props.dispatch(createAction('modelAnalysisAectificationModel/updateCheckedRectification')({
                params: {
                    "id": this.state.ID,
