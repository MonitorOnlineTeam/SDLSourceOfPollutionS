 ...
 * @LastEditTime: 2024-09-27 09:26:31
...
export default class KeyParameterVerificationProblemDetail extends Component {
    ...
    statusPageOnRefresh = () => {
        ...
        this.props.dispatch(createAction('keyParameterVerificationModel/getVerificationProblemDetail')(
            {
                params: SentencedToEmpty(this.props, ['route', 'params', 'params', 'requestParam',], {}),
    ...
    renderItem = ({ item, index }) => {
        ...
        item.isLast = SentencedToEmpty(this.props
            ...
            , []).length == 1
        let typeID = SentencedToEmpty(this.props, ['route', 'params', 'params', 'requestParam', 'typeID'], '')
        return (<View style={{
                    ...
                    onPress={() => {
                        ...
                        this.props.dispatch(NavigationActions.navigate({
                            ...
                            params: {
                                ...
                                data: item,
                                superListData: SentencedToEmpty(this.props, ['route', 'params', 'params', 'itemData'], {}),
                            }
                        }))
                    }}
                >
    ...
    render() {
        ...
        >
            <View style={{ width: SCREEN_WIDTH, flex: 1 }}>
                <View style={{
                    width: SCREEN_WIDTH, height: 91, backgroundColor: 'white',
                    ...
                    <View style={{
                        width: SCREEN_WIDTH - 38, flexDirection: 'row'
