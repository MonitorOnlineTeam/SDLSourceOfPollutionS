 ...
 * @LastEditTime: 2023-05-17 13:25:49
 * @FilePath: /SDLMainProject34/app/pOperationContainers/KeyParameterVerification/KeyParameterVerificationList.js
 */
    ...
    renderItem = ({ item, index }) => {
        ...
        >
            ...
            <View style={{height:22.5}}>
                <Text numberOfLines={1} style={{color:'#666666'
