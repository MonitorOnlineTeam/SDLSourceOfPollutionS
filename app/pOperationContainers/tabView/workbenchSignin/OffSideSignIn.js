...
@connect(({ signInModel }) => ({
    ...
    signCount: signInModel.signCount,
    signInType: signInModel.signInType,
}))
export default class OffSideSignIn extends Component {
    ...
    getSurroundings = async () => {
        ...
        AMapPOISearch.doSearchQuery(
            ...
            callback = (result) => {
                ...
                selectedEnt.address = SentencedToEmpty(listData, [0, 'address'], '');
    ...
    clockIn = () => {
         ...
         * Province行政区、Address详细地址、PlaceName地点
         */
        let signInParams = {};
        ...
        signInParams.Province = this.props.signInEntItem.ProviceName;
        signInParams.PlaceName = this.props.signInEntItem.title;
