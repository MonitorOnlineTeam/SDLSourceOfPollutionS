 ...
 * @LastEditTime: 2023-07-14 10:36:22
 * @FilePath: /SDLMainProject36/app/pOperationContainers/tabView/workbench/ManualClaimTask.js
 */
...
export default class ManualClaimTask extends Component {
    ...
    _renderItemList = ({item:{pointName,entName,createTime,taskID,overHour,overDay}}) => {
        return <TouchableOpacity
            ...
            <View style={[{height:107.5,width:SCREEN_WIDTH,backgroundColor:'white'
            , flexDirection:'row',alignItems:'center'
             }]}>
                <View style={[{flex:1,height:79.5, marginTop:14.5,marginBottom:13.5,marginLeft:19
                ...
                <View style={[{height:34,width:34,backgroundColor:'#F78259',marginHorizontal:14.5,borderRadius:17
