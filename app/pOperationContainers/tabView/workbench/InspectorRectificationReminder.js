/*
 * @Description: 系统设施核查消息 列表
 * @LastEditors: hxf
 * @Date: 2022-05-29 16:14:48
 * @LastEditTime: 2023-09-12 18:02:21
 * @FilePath: /SDLMainProject36/app/pOperationContainers/tabView/workbench/InspectorRectificationReminder.js
 */
...
export default class InspectorRectificationReminder extends Component {
    ...
    renderItem = ({item,index}) => {
        return(<View style={{width:SCREEN_WIDTH, }}>
            ...
            </View>
            {
                ...
                >
                    <View style={{height:90,width:SCREEN_WIDTH
                    ,backgroundColor:'#FFFFFF',alignItems:'center'}}>
                        ...
                        ,justifyContent:'space-between'}}>
                            <View style={{flexDirection:'row',alignItems:'center'}}>
                                <Image source={require('../../../images/ic_msg_audit.png')}
                                style={{height:16,width:16,marginRight:10}} />
                                <Text style={{fontSize:'#333333',fontSize:15}}>{item.title}</Text>
                            </View>
                            <View style={{flexDirection:'row',alignItems:'center'}}>
                        ...
                        <View style={{width:SCREEN_WIDTH-40,flex:1,justifyContent:'center'}}>
                            <Text numberOfLines={2} ellipsizeMode={'tail'} style={{color:'#666666',fontSize:12,lineHeight:16}}>{item.Msg}</Text>
                        </View>
                    </View>
                </TouchableOpacity>
                :<View style={{height:90,width:SCREEN_WIDTH
