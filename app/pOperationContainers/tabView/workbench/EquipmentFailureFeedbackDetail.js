 ...
 * @LastEditTime: 2024-09-27 14:01:00
            ...
            <ScrollView style={{ width: SCREEN_WIDTH }}>
                <View style={[{ backgroundColor: '#fff' }]}>
                    ...
                    <View style={[{ width: SCREEN_WIDTH, height: 44, paddingHorizontal: 20, alignItems: 'center', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        ...
                        <Text style={[{ marginLeft: 28, fontSize: 14, color: '#666' }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'ParentName'], '--')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, height: 44, paddingHorizontal: 20, alignItems: 'center', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <Text style={[{ fontSize: 14, color: '#333' }]}>* 监测点位</Text>
                        <Text style={[{ marginLeft: 28, fontSize: 14, color: '#666' }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'PointName'], '--')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, height: 44, paddingHorizontal: 20, alignItems: 'center', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <Text style={[{ fontSize: 14, color: '#333' }]}>故障单元：</Text>
                        <Text style={[{ marginLeft: 28, fontSize: 14, color: '#666' }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'FaultUnitName'], '--')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, height: 44, paddingHorizontal: 20, alignItems: 'center', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <Text style={[{ fontSize: 14, color: '#333' }]}>故障时间：</Text>
                        <Text style={[{ marginLeft: 28, fontSize: 14, color: '#666' }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'CreatDateTime'], '--')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, height: 44, paddingHorizontal: 20, alignItems: 'center', flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <Text style={[{ fontSize: 14, color: '#333' }]}>名称型号：</Text>
                        <Text style={[{ marginLeft: 28, fontSize: 14, color: '#666' }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'EquipmentName'], '--')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        ...
                        <Text style={[{ fontSize: 14, color: '#666', lineHeight: 25, marginBottom: 11 }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'FaultPhenomenon'], '----')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <View style={[{ width: SCREEN_WIDTH, height: 44, alignItems: 'center', flexDirection: 'row' }]}>
                            <Text style={[{ fontSize: 14, color: '#333' }]}>原因分析</Text>
                        </View>
                        <Text style={[{ fontSize: 14, color: '#666', lineHeight: 25, marginBottom: 11 }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'CauseAnalysis'], '----')}</Text>
                    </View>
                    <View style={[{ width: SCREEN_WIDTH, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#e5e5e5' }]}>
                        <View style={[{ width: SCREEN_WIDTH, height: 44, alignItems: 'center', flexDirection: 'row' }]}>
                            <Text style={[{ fontSize: 14, color: '#333' }]}>处理方法</Text>
                        </View>
                        <Text style={[{ fontSize: 14, color: '#666', lineHeight: 25, marginBottom: 11 }]}>{SentencedToEmpty(this.props, ['route', 'params', 'params', 'item', 'ProcessingMethod'], '----')}</Text>
                    </View>
                </View>
            </ScrollView>
        );
