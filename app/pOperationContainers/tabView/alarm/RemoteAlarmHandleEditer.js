 ...
 * @LastEditTime: 2024-11-28 16:01:30
...
import { AlertDialog, DeclareModule, SDLText, SimpleLoadingComponent, SimpleLoadingView } from '../../../components';
...
export default class RemoteAlarmHandleEditer extends Component {
    ...
    render() {
        const OperationFlag = SentencedToEmpty(this.props, ['route', 'params', 'params', 'OperationFlag'], -1)
        let alertOptions = {
            headTitle: '提示',
            messText: `确定${OperationFlag == 3 ? '该报警无需处理' : ''}${OperationFlag == 2 ? '对该报警远程处理' : ''}${OperationFlag != 2 && OperationFlag != 3 ? '进行此处理' : ''}吗？`,
