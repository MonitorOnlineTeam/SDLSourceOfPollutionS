 ...
 * @LastEditTime: 2023-05-16 09:47:29
 * @FilePath: /SDLMainProject34/app/pOperationContainers/shanghaihuanjing/SHEnterpriseList.js
 */
        ...
        >
            <View style={{width:SCREEN_WIDTH,backgroundColor:'white'}}>
                ...
                , justifyContent:'center'
                    ...
                    <Text style={{ lineHeight:16, fontSize:13}}>{
                        `${
