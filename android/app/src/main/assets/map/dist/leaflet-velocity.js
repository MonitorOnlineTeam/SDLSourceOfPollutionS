...
L.VelocityLayer = (L.Layer ? L.Layer : L.Class).extend({
  ...
  onAdd: function onAdd(map) {
    ...
    console.log('VelocityLayer L.canvasLayer');
  ...
  _startWindy: function _startWindy() {
    console.log('_startWindy');
    var bounds = this._map.getBounds();

    var size = this._map.getSize(); // bounds, width, height, extent
    console.log('size.x = ', size.x, ',size.y = ', size.y);
    console.log('bounds._southWest = ', bounds._southWest, ',bounds._northEast = ', bounds._northEast);
  ...
  _initWindy: function _initWindy(self) {
    ...
    console.log('new Windy(options) = ', options);
...
var Windy = function Windy(params) {
  console.log('Windy params = ', params);
  ...
  var setData = function setData(data) {
    console.log('Windy setData = ', setData);
    gridData = data;
  };
  ...
  var createField = function createField(columns, bounds, callback) {
    ...
    field.randomize = function (o) {
      // console.log('field.randomize o = ', o);
  ...
  var animate = function animate(bounds, field) {
    console.log('animate');
    console.log(' animate field = ', field);
    ...
    var particles = [];
    // console.log('evolve 3 particles = ', particles);
    for (var i = 0; i < particleCount; i++) {
      particles.push(field.randomize({
        age: Math.floor(Math.random() * MAX_PARTICLE_AGE) + 0
      }));
    }
    // console.log('evolve 4 particles = ', particles);
    function evolve() {
      let count = 0;
      // console.log('hxf evolve');
      buckets.forEach(function (bucket) {
        bucket.length = 0;
      });
      // console.log('evolve 1 buckets = ', buckets);
      // console.log('evolve 2 particles = ', particles);
      ...
      // console.log('evolve 5 count = ', count);
      // console.log('evolve 5 buckets = ', buckets);
    }
    ...
    function draw() {
      ...
      // console.log('draw buckets = ', buckets);
      // debugger;
